      ...
      <div className={classes.loginWrapper}>
        ...
        <div className={classes.loginRightSide}>
          ...
          <form onSubmit={handleLogin} className={classes.loginForm}>
            <input type='email' placeholder='januram123@gmail.com' onChange={(e)=> setEmail(e.target.value)}/>
            <input type='password' placeholder='Januram1234#' onChange={(e)=> setPassword(e.target.value)}/>
